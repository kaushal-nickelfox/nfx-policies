...
import { FileText, Shield, BookOpen, CheckCircle, Users, Zap, AlertCircle } from 'lucide-react';
...
function AuthErrorBanner() {
  ...
  const message = AUTH_ERRORS[errorCode] ?? AUTH_ERRORS.Default;
  return (
    <div
      style={{
        width: '100%',
    ...
    >
      ...
      <p style={{ margin: 0, fontSize: 13, color: '#DC2626', fontWeight: 500, lineHeight: 1.5 }}>
        {message}
      </p>
    </div>
  );
...
const features = [
  {
    ...
    desc: 'Azure AD SSO with role-based access control',
  },
  {
    icon: BookOpen,
    title: 'Policy Management',
    desc: 'Upload, version, and distribute HR policies',
  },
  {
    icon: CheckCircle,
    title: 'Acknowledgement Tracking',
    desc: 'Real-time compliance monitoring by department',
  },
  {
    icon: Users,
    title: 'Employee Dashboard',
    desc: 'Personal policy history and completion status',
  },
];
    ...
    >
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1, marginBottom: isMobile ? 0 : 40 }}>
          ...
          {!isMobile && (
            <p
              style={{ margin: 0, fontSize: 15, lineHeight: 1.75, color: '#C8C0D0', maxWidth: 390 }}
            >
              A unified platform for policy distribution, acknowledgement tracking, and compliance
              reporting.
            </p>
          )}
        </div>
            ...
            {features.map(({ icon: Icon, title, desc }) => (
              ...
              >
                ...
                <div>
                  ...
                  <p
                    style={{ margin: '3px 0 0', fontSize: 12.5, color: '#C8C0D0', lineHeight: 1.5 }}
                  >
                    {desc}
                  </p>
                </div>
        ...
        {!isMobile && (
          <>
            ...
            >
              ...
              <span style={{ fontSize: 12, color: 'rgba(200,192,208,0.60)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 32 }}>
            ...
            >
              <svg viewBox="0 0 24 24" width="17" height="17" fill="none">
                <path
                  d="M12 2L3 6.5V12c0 4.5 3.8 8.7 9 10 5.2-1.3 9-5.5 9-10V6.5L12 2Z"
                  fill="#3b82f6"
                  fillOpacity="0.15"
                  stroke="#3b82f6"
                  strokeWidth="1.5"
