    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          width: 500, height: 500, top: -140, right: -140,
          background: '#563D66', filter: 'blur(90px)', opacity: 0.6,
          pointerEvents: 'none',
        }} />
        {/* Blob — bottom right */}
        <div style={{
          ...
          background: '#563D66', filter: 'blur(75px)', opacity: 0.5,
          pointerEvents: 'none',
        }} />

        {/* Logo */}
        <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', gap: 14, marginBottom: 56 }}>
          <div style={{
            ...
            <FileText size={24} color="rgba(255,255,255,0.92)" />
          </div>
          <span style={{ fontSize: 22, fontWeight: 900, color: '#fff', letterSpacing: '-0.3px' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, marginBottom: 40 }}>
          ...
          <p style={{
            ...
            color: '#C8C0D0', maxWidth: 390,
          }}>
            A unified platform for policy distribution, acknowledgement
      ...
      >
        {/* Auth content — max 400px wide, centered */}
        <div style={{
          width: '100%',
          maxWidth: 400,
          display: 'flex',
          ...
          <h2 style={{
            ...
            color: '#0f172a', letterSpacing: '-0.7px',
            textAlign: 'center',
          }}>
            Welcome back
          </h2>
