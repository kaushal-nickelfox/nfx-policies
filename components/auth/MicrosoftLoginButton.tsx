  ...
  return (
    <button
      ...
      style={{
        ...
        background: busy
          ? '#4a6fd6'
          : 'linear-gradient(135deg, #2F5BE7 0%, #4070f0 100%)',
      ...
      onMouseEnter={e => {
        if (!busy) {
          ...
          (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 6px 22px rgba(47,91,231,0.45)';
        }
      }}
      onMouseLeave={e => {
        (e.currentTarget as HTMLButtonElement).style.transform = 'scale(1)';
        (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 4px 16px rgba(47,91,231,0.35)';
      }}
    >
      {busy ? (
        /* Spinner */
